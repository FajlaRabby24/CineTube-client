          ...
          <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="text-neutral-500">
                Monitor platform population and access parameters.
              </p>
            </div>
              ...
              {users.length === 0 ? (
                ...
                users.map((user: IUser) => (
                  ...
                  >
                    ...
                    <TableCell>
                      {user.emailVerified ? (
                        <Badge className="bg-blue-600/20 text-blue-400 ring-1 ring-blue-600/40 rounded-md px-2 py-0.5 text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 w-fit">
                ...
                {[
                  {
                    ...
                    items: [
                      ...
                      {
                        key: "Signal Line",
                        val: selectedUser.phoneNumber,
                        icon: PhoneIcon,
                      },
                      {
                        key: "Access Role",
                        val: selectedUser.role,
                        icon: ShieldIcon,
                      },
                      {
                        key: "Cipher Status",
                        val: selectedUser.needPasswordChange
                          ? "Reset Required"
                          : "Secure",
                        icon: ShieldIcon,
                      },
                  ...
                  <div className="group rounded-2xl border border-red-900/50 bg-red-600/10 p-4 transition-all hover:border-red-900/80">
                    ...
                    <div className="grid gap-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="space-y-0.5">
                          <p className="text-[10px] font-bold text-red-900 uppercase tracking-tighter">
                            Banned At
                          </p>
