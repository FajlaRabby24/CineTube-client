...
import { getUserPayments, IPayment } from "@/services/Dashboard/payment.service";
...
const Payments = ({ initialQueryString }: PaymentsProps) => {
  ...
  const { data: paymentsData, isLoading } = useQuery({
    queryKey: ["user-payments", page, status, plan],
    queryFn: () => getUserPayments(queryParams.toString()),
  });
            ...
            <div className="space-y-6 pt-4">
              ...
              {selectedPayment.description && (
                <div className="space-y-2">
                  ...
                  <p className="text-sm italic">{selectedPayment.description}</p>
                </div>
              )}
