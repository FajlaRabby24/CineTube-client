...
import { getUserNotifications, INotification } from "@/services/Dashboard/notification.service";
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  !notification.isRead && "bg-white/[0.01] border-red-600/10 shadow-[inner_0_0_20px_rgba(220,38,38,0.05)]"
                )}
              >
                {!notification.isRead && (
                ...
                <div className="flex items-center gap-6">
                  <div className={cn("flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl shadow-2xl", config.bg)}>
                  ...
                  <div className="hidden sm:flex flex-col items-end gap-2 pr-4">
                     <span className={cn(
                       ...
                       !notification.isRead ? "text-red-500 bg-red-500/10" : "text-neutral-600 bg-white/5"
                     )}>
